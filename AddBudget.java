...
public class AddBudget extends javax.swing.JFrame {
    ...
    private void jButton_ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ADDActionPerformed
        if (checkInputs()) {
            ...
            //*******************************************************************************************************************
            /*1*/
            String cname = ((String) (jComboBox_Category.getSelectedItem()));
            /*2*/
            float budget = Float.parseFloat(jTextField_Budget.getText());
            /*3*/
            int userid = getUserId(userName);
            java.util.Date currentDate = new java.util.Date();
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            /*4*/
            String monthYear = sdf.format(currentDate);
    ...
    private void jButton_Category1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Category1ActionPerformed
        ...
        if (selectedItem.equals("food")
            ...
            JOptionPane.showMessageDialog(null, "You cannot remove that category name from the menu.");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Category name removed from menu.");
