...
public class ManageBudget extends javax.swing.JFrame {
    ...
    public ArrayList<Spending> getSpendingList() {
        ...
        String query = "SELECT * FROM spending WHERE user_id = ? AND MONTH(date) = MONTH(CURRENT_DATE()) ORDER BY category_name";
        Spending spending;
        try {
    ...
    public void ShowItem(int index) {
        ...
        jComboBox_Category.setSelectedItem(getSpendingList().get(index).getCategoryName());
    ...
    private void initComponents() {
        ...
        historyLabel.setBackground(new java.awt.Color(97, 44, 9));
        historyLabel.setForeground(new java.awt.Color(255, 255, 255));
        historyLabel.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(historyLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
     ...
     private void historyLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
    ...
    public boolean checkInputs() {
        if (jTextField_Spending.getText() == null
