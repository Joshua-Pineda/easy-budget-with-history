...
public class History extends javax.swing.JFrame {
    ...
    public ArrayList<Spending> getSpendingList() {
        ...
        String query = "SELECT * FROM spending WHERE user_id = ? ORDER BY date";
        Spending spending;
        try {
    ...
    private void jButton_ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ADDActionPerformed
        if (!jTextField_Spending.getText().equals("")) {
            PreparedStatement ps;
    ...
    public boolean checkCatgeoryForBudget() {
        PreparedStatement ps;
        String query = "SELECT categoryID FROM categories WHERE name = ? AND MONTH(date) = MONTH(?) "
                + "AND YEAR(date) = YEAR(?) "
                + "AND user_id = ?";
         SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String date = sdf.format(jDateChooser_Date.getDate());
        ...
        try {
            ...
            ps.setString(1, ((String) (jComboBox_Category.getSelectedItem())));
             ps.setString(2,  date);
              ps.setString(3, date);
            ps.setInt(4, getUserId(userName));
            rs = ps.executeQuery();
